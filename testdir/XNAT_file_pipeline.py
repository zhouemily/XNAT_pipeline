...
def main():
    ...
    pl.svg_to_png(ut.svg_fname1, 'temp1.png', png_image.width*2, png_image.height*1.5, remove_margins=True)
    # Resize and convert the second SVG 
    pl.svg_to_png(ut.svg_fname2, 'temp2.png', png_image.width *2, png_image.height *1.5, remove_margins=True)
    if DEBUG:
        print("png_image.width="+str(png_image.width*2))
        print("png_image.height="+str(png_image.height*1.5))
    ...
    stacked_image.paste(image1, (500, png_image.height+200))
    stacked_image.paste(image2, (500, 2 * png_image.height+1000))
